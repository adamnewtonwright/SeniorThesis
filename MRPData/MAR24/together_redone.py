...
plt.errorbar(angler, effr,yerr = reperr, label = '700 kHz Rep. Rate Circular', fmt = '.')
...
plt.errorbar(angles,effr,yerr = effrerror,label = 'Rep Rate 700 kHz Linear', fmt = '.')
...
plt.grid(True)
plt.legend()
plt.savefig('together_redone.pdf')
plt.show()
