...
%\vspace*{\fill}
%
%\textit{``And God said, `Let there be light,' and there was light. God saw that the light was good, and he separated the light from the dark.''}
%\begin{flushright}
%Genesis 1:3
%\end{flushright}
%\vspace*{\fill}
